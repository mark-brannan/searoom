...
import { selectHull, placeLights, BearingView, PlanView, ProfileView } from 'nav-wright';
import type { Aspect } from 'nav-wright';
import { BenchyView } from '../render/BenchyView';
import type { BenchySceneLabels } from '../render/benchyLabels';
...
export function Sandbox({
  ...
  const sceneLabels: BenchySceneLabels = useMemo(
    () => ({
      bearingAlt: (theta) =>
